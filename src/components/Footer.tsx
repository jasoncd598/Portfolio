...
export default function Footer() {
  ...
  return (
    <footer
      id="main-footer"
      className="py-12 border-t border-slate-100 dark:border-slate-900 bg-slate-50 dark:bg-slate-950 transition-colors duration-300 print:hidden"
    >
      <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-6">
        ...
        <button
          ...
          className="flex items-center gap-1 text-xs font-mono font-bold uppercase text-slate-400 hover:text-indigo-600 dark:text-slate-500 dark:hover:text-indigo-400 transition cursor-pointer"
        >
