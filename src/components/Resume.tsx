...
export default function Resume() {
  ...
  return (
    <section
      id="resume"
      className="py-24 border-t border-slate-200/60 dark:border-white/5 bg-transparent transition-colors duration-300 relative print:bg-white print:text-black print:p-0 print:border-none"
    >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-7 flex flex-col gap-6 print:hidden">
            <h3 className="text-xl font-display font-bold text-slate-900 dark:text-white flex items-center gap-2 mb-2 text-left">
              <Building2 className="text-fuchsia-600 dark:text-fuchsia-400" size={20} />
              ...
              {EXPERIENCES.map((exp, index) => {
                ...
                return (
                  <div key={exp.id} className="relative group">
                    {/* Circle Anchor */}
                    <div className="absolute -left-7.75 top-1 w-4 h-4 rounded-full border-2 border-fuchsia-500 bg-white dark:bg-slate-950 group-hover:gradient-fill transition-colors" />

                    <div className="flex flex-col gap-2 p-5 glass-card rounded-xl hover:shadow-lg hover:shadow-fuchsia-500/10 transition-shadow">
                      ...
                      <div className="flex justify-between items-start gap-2">
                        <div className="flex flex-col">
                          ...
                          <span className="text-xs font-mono gradient-text mt-1 font-semibold flex items-center gap-1">
                            {exp.company}
                          </span>
                        </div>
                        ...
                        <button
                          ...
                          className="p-1 rounded glass-chip hover:bg-white/80 dark:hover:bg-white/10 text-slate-500 cursor-pointer"
                        >
          ...
          <div className="lg:col-span-5 flex flex-col gap-4 text-left print:col-span-12 print:w-full">
            <div className="flex items-center justify-between print:hidden">
              <h3 className="text-xl font-display font-bold text-slate-900 dark:text-white flex items-center gap-2">
                <FileCode className="text-fuchsia-600 dark:text-fuchsia-400" size={20} />
                Printable PDF Copy
              </h3>
              <button
                id="doc-print-btn"
                onClick={triggerPrint}
                className="flex items-center gap-1.5 px-3 py-1.5 glass-chip hover:bg-white/80 dark:hover:bg-white/10 rounded-lg text-xs font-mono font-bold text-fuchsia-700 dark:text-fuchsia-400 cursor-pointer transition"
              >
                <Printer size={13} />
                Print Resume
              </button>
